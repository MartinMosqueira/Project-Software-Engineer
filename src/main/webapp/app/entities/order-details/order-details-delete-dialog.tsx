...
export const OrderDetailsDeleteDialog = () => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="shoppingCartApp.orderDetails.delete.question">
        <Translate contentKey="shoppingCartApp.orderDetails.delete.question" interpolate={{ id: orderDetailsEntity.id }}>
