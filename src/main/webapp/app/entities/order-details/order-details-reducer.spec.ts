...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_ORDERDETAILS_LIST actions', async () => {
    ...
    it('dispatches FETCH_ORDERDETAILS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_ORDERDETAILS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_ORDERDETAILS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_ORDERDETAILS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_ORDERDETAILS actions', async () => {
      const expectedActions = [
        {
