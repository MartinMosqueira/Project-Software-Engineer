...
import app.project.cart.domain.Company;
import app.project.cart.repository.CompanyRepository;
...
/**
 * REST controller for managing {@link app.project.cart.domain.Company}.
 */
@RestController
@RequestMapping("/api")
@Transactional
